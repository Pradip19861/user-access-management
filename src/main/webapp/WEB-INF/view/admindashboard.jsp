<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <body>
        <%@ include file="components/navbar.jsp"%>
            ...
            <div class="container admin mt-2">
                <%@ include file="components/message.jsp"%>
                    <div class="row mt-3">
                        <div class="col-md-4">
                            <div class="card hover" data-toggle="modal" data-target="#show-users-modal">
                                <div class="card-body text-center">
                                    ...
                                    <h2 class="text-muted">Total Employees</h2>
                                </div>
                            </div>
                        </div>

                        <div class="col-md-4">
                            <div class="card hover" data-toggle="modal" data-target="#total-account-modal">
                                <div class="card-body text-center">
                                    <div class="container">
                        ...
                        <div class="col-md-4">
                            <div class="card hover" data-toggle="modal" data-target="#show-transaction-modal">
                                <div class="card-body text-center">
                                    <div class="container">
                                    ...
                                    <h2 class="text-muted">Total Software</h2>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="modal-dialog custom-modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header custom-bg text-white text-center">
                            <h5 class="modal-title" id="exampleModalLongTitle">Total Customer
                            </h5>
            ...
            <div class="modal fade" id="total-account-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
                <div class="modal-dialog custom-modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header custom-bg text-white text-center">
                            <h5 class="modal-title" id="exampleModalLongTitle">Total Account
                            </h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
						<span aria-hidden="true">&times;</span>
					</button>
                        ...
                        <div class="modal-body">
                            <div class="table-responsive">
                                <table class="table">
                                    <thead class="custom-bg text-white">
                                        <tr>
                                            ...
                                            <th scope="col">Software Status</th>
                                            <th scope="col">Software Checkbook</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <%
								...
								%>
									...
									%>
                                                        <td class="mid-align"><a href="changeAccountStatus?accountId=<%=acc.getId()%>&accountStatus=<%=Constants.AccountStatus.LOCK.value()%>"><button
												type="button" class="btn custom-bg text-white">Reject</button>
									</a></td>
                                                        <%
									} else {
									%>
                                                            <td class="mid-align"><a href="changeAccountStatus?accountId=<%=acc.getId()%>&accountStatus=<%=Constants.AccountStatus.OPEN.value()%>"><button
												type="button" class="btn custom-bg text-white">Grant</button>
									</a></td>
                                                            <%
									}
									%>
									...
									%>
                                                                            <td class="mid-align">
                                                                                <%=Constants.CheckbookStatus.NOT_APPLIED.value()%>
                                                                            </td>
                                                                            <%
									}
									%>
									...
									%>
                                                                                    <td class="mid-align"><a href="updateCheckbookStatus?customerId=<%=cust.getId()%>&status=<%=Constants.CheckbookStatus.APPROVED.value()%>"><button
            ...
            <div class="modal fade" id="show-transaction-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
                <div class="modal-dialog custom-modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header custom-bg text-white text-center">
                            <h5 class="modal-title" id="exampleModalLongTitle">Total Software</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
						<span aria-hidden="true">&times;</span>
					</button>
                        </div>
                        <div class="modal-body">
                            <div class="table-responsive">
								...
								%>
									...
									%>
                                                        <td class="mid-align">
                                                            <%=accountDao.getById(transaction.getToAccountId()).getCardNo()%>
                                                        </td>
                                                        <%
									} else {
									%>
